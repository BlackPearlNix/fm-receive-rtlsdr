...
class fm_rtlsdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_rtlsdr")
        ...
        self.rfGain = rfGain = 47
        self.mod = mod = 0
        self.freq = freq = 91100000
        self.audioGain = audioGain = 1

        ##################################################
        # Blocks
        ##################################################

        self._rfGain_range = qtgui.Range(0, 49, 1, 47, 200)
        self._rfGain_win = qtgui.RangeWidget(self._rfGain_range, self.set_rfGain, "RF Gain", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._rfGain_win)
        # Create the options list
        self._mod_options = [0, 1]
        # Create the labels list
        self._mod_labels = ['Inbuilt', 'Custom']
        # Create the combo box
        self._mod_tool_bar = Qt.QToolBar(self)
        self._mod_tool_bar.addWidget(Qt.QLabel("De Modulation type" + ": "))
        self._mod_combo_box = Qt.QComboBox()
        self._mod_tool_bar.addWidget(self._mod_combo_box)
        for _label in self._mod_labels: self._mod_combo_box.addItem(_label)
        ...
        self.top_layout.addWidget(self._mod_tool_bar)
        self._freq_range = qtgui.Range(88000000, 108000000, 100000, 91100000, 200)
        ...
        self._audioGain_range = qtgui.Range(0.5, 5, 0.25, 1, 200)
        self._audioGain_win = qtgui.RangeWidget(self._audioGain_range, self.set_audioGain, "Amplify", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._audioGain_win)
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            48000, #bw
            "Demodulated Audio Spectrum", #name
            1,
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_selector_0 = blocks.selector(gr.sizeof_float*1,mod,0)
        self.blocks_selector_0.set_enabled(True)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(audioGain)
        ...
        self.analog_fm_deemph_0 = analog.fm_deemph(fs=192e3, tau=(75e-6))
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.blocks_selector_0, 0))
        self.connect((self.blocks_complex_to_arg_0, 0), (self.analog_fm_deemph_0, 0))
    ...
    def set_audioGain(self, audioGain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.audioGain)




def main(top_block_cls=fm_rtlsdr, options=None):
